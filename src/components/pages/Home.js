    ...
    <div>
      <section className="title">
        ...
        <div className="row justify-content-center">
          ...
          <p>
            My name is Vida Nsiah.
            I am a Senior Biomedical Scientist who want to change carrier to become a web developer/designer.
            I want to work in both, backend and frontend programming.
